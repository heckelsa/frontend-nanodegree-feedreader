...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
		...
		// loops through each feed and ensures that a url is
		// definden and not empty
		...
		// loops through each feed and ensures that a name is
		// definden and not empty
    ...
    describe('The Menu', function() {
        ...
        it('is displayed and hidden correctly', function() {
			...
			// through the click the menu has to be displayed. This
			// means, the Class menu-hidden should not be in the body.
            expect($('body').hasClass("menu-hidden")).not.toBe(true);
            // Triggers a new click on the class menu-icon-link
            $('.menu-icon-link').trigger('click');
			// now the menu should be hidden again. the class
			// menu-hidden should be in the body again
            expect($('body').hasClass("menu-hidden")).toBe(true);
        });
    });
    ...
    describe('Initial Entries', function() {
		...
		// calls before the test the function loadFeed with the
		// jasmine function done() as callback. So jasmine knows, when
		// the async loading is finished.
		...
		// after the initial loading is completed it checks if a
		// entry inside the class feed is existing.
